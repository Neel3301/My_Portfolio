...
const Skills = () => {
    ...
    function scroll_left(){
      document.getElementById('right').scrollBy(-250,0);
    };
      ...
      <div className='right' id="right">
        ...
        onMouseOut={()=>{
          ...
          onMouseOut={()=>{
            ...
            <Image src="/assets/skills/html.jpg" layout="fill" alt='Skills'/>
            </div>
          ...
          onMouseOut={()=>{
            ...
            <p>Ao contrário da crença popular, o Lorem Ipsum não é simplesmente texto aleatório.</p>
            <div className='imgContainer'>
            <Image src="/assets/skills/js-3.png" layout="fill" alt='Skills'/>
            </div>
          ...
          onMouseOut={()=>{
            ...
            <p>Ao contrário da crença popular, o Lorem Ipsum não é simplesmente texto aleatório.</p>
            <div className='imgContainer'>
            <Image src="/assets/skills/php.png" layout="fill" alt='Skills'/>
            </div>
          ...
          onMouseOut={()=>{
            ...
            <p>Ao contrário da crença popular, o Lorem Ipsum não é simplesmente texto aleatório.</p>
            <div className='imgContainer'>
            <Image src="/assets/skills/reactjs.jpg" layout="fill" alt='Skills'/>
            </div>
          ...
          onMouseOut={()=>{
            ...
            <p>Ao contrário da crença popular, o Lorem Ipsum não é simplesmente texto aleatório.</p>
            <div className='imgContainer'>
            <Image src="/assets/skills/nodejs.jpg" layout="fill" alt='Skills'/>
            </div>
          ...
          onMouseOut={()=>{
            ...
            <p>Ao contrário da crença popular, o Lorem Ipsum não é simplesmente texto aleatório.</p>
            <div className='imgContainer'>
            <Image src="/assets/skills/nextjs.png" layout="fill" alt='Skills'/>
            </div>
          ...
          onMouseOut={()=>{
            ...
            <p>Ao contrário da crença popular, o Lorem Ipsum não é simplesmente texto aleatório.</p>
            <div className='imgContainer'>
            <Image src="/assets/skills/mongodb.jpg" layout="fill" alt='Skills'/>
            </div>
          ...
          onMouseOut={()=>{
            ...
            <p>Ao contrário da crença popular, o Lorem Ipsum não é simplesmente texto aleatório.</p>
            <div className='imgContainer'>
            <Image src="/assets/skills/java.jpg" layout="fill" alt='Skills'/>
            </div>
          ...
          onMouseOut={()=>{
            ...
            <p>Ao contrário da crença popular, o Lorem Ipsum não é simplesmente texto aleatório.</p>
            <div className='imgContainer'>
            <Image src="/assets/skills/pyhton.png" layout="fill" alt='Skills'/>
            </div>
          ...
          onMouseOut={()=>{
            ...
            <p>Ao contrário da crença popular, o Lorem Ipsum não é simplesmente texto aleatório.</p>
            <div className='imgContainer'>
            <Image src="/assets/skills/flutter.jpg" layout="fill" alt='Skills'/>
            </div>
          ...
          onMouseOut={()=>{
            ...
            <p>Ao contrário da crença popular, o Lorem Ipsum não é simplesmente texto aleatório.</p>
            <div className='imgContainer'>
            <Image src="/assets/skills/dart.png" layout="fill" alt='Skills'/>
            </div>
          ...
          onMouseOut={()=>{
            ...
            <p>Ao contrário da crença popular, o Lorem Ipsum não é simplesmente texto aleatório.</p>
            <div className='imgContainer'>
              <Image src="/assets/skills/cpp.jpg" layout="fill" alt='Skills'/>
            </div>
          </div>
