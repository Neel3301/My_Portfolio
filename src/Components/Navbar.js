...
const Navbar = () => {
    ...
    function smNav_op_1(){
        document.querySelectorAll('.sm_nav_op_data').forEach((Element) =>{Element.classList.remove('active')});
        document.getElementById('sm_nav_op_data_1').classList.toggle('active');

        document.querySelectorAll('.nav_op').forEach((Element) =>{Element.classList.remove('active')});
        document.getElementById('sm_nav_op_1').classList.toggle('active');
    }
    function smNav_op_2(){
        document.querySelectorAll('.sm_nav_op_data').forEach((Element) =>{Element.classList.remove('active')});
        document.getElementById('sm_nav_op_data_2').classList.toggle('active');

        document.querySelectorAll('.nav_op').forEach((Element) =>{Element.classList.remove('active')});
        document.getElementById('sm_nav_op_2').classList.toggle('active');
    }
    function smNav_op_3(){
        document.querySelectorAll('.sm_nav_op_data').forEach((Element) =>{Element.classList.remove('active')});
        document.getElementById('sm_nav_op_data_3').classList.toggle('active');
        
        document.querySelectorAll('.nav_op').forEach((Element) =>{Element.classList.remove('active')});
        document.getElementById('sm_nav_op_3').classList.toggle('active');
    }
    function smNav_op_4(){
        document.querySelectorAll('.sm_nav_op_data').forEach((Element) =>{Element.classList.remove('active')});
        document.getElementById('sm_nav_op_data_4').classList.toggle('active');
        
        document.querySelectorAll('.nav_op').forEach((Element) =>{Element.classList.remove('active')});
        document.getElementById('sm_nav_op_4').classList.toggle('active');
    }
    function smNav_op_5(){
        document.querySelectorAll('.sm_nav_op_data').forEach((Element) =>{Element.classList.remove('active')});
        document.getElementById('sm_nav_op_data_5').classList.toggle('active');
        
        document.querySelectorAll('.nav_op').forEach((Element) =>{Element.classList.remove('active')});
        document.getElementById('sm_nav_op_5').classList.toggle('active');
    }
    function smNav_op_6(){
        document.querySelectorAll('.sm_nav_op_data').forEach((Element) =>{Element.classList.remove('active')});
        document.getElementById('sm_nav_op_data_6').classList.toggle('active');
        
        document.querySelectorAll('.nav_op').forEach((Element) =>{Element.classList.remove('active')});
        document.getElementById('sm_nav_op_6').classList.toggle('active');
    }
        ...
        <nav className="navbar" id='navbar'>
            ...
            <div className='hidden_nav' id='hidden_nav'>
                <div className='hidden_nav_container'>
                    ...
                    <div className='left leftSm'>
                        <a href='#' className='nav_op active' id='sm_nav_op_1' onClick={smNav_op_1}>About Me</a>
                        <div className='sm_nav_op_data active' id='sm_nav_op_data_1'>
                            <p>
                        ...
                        <a href='#' className='nav_op' id='sm_nav_op_2' onClick={smNav_op_2}>My Project</a>
                        <div className='sm_nav_op_data' id='sm_nav_op_data_2'>
                            <p>
                        ...
                        <a href='#' className='nav_op' id='sm_nav_op_3' onClick={smNav_op_3}>My Clients</a>
                        <div className='sm_nav_op_data' id='sm_nav_op_data_3'>
                            <p>
                        ...
                        <a href='#' className='nav_op' id='sm_nav_op_4' onClick={smNav_op_4}>My Skills</a>
                        <div className='sm_nav_op_data' id='sm_nav_op_data_4'>
                            <p>
                        ...
                        <a href='#' className='nav_op' id='sm_nav_op_5' onClick={smNav_op_5}>Reach Me</a>
                        <div className='sm_nav_op_data' id='sm_nav_op_data_5'>
                            <p>
                        ...
                        <a href='#' className='nav_op' id='sm_nav_op_6' onClick={smNav_op_6}>Contact Me</a>
                        <div className='sm_nav_op_data' id='sm_nav_op_data_6'>
                            <p>
